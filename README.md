...
|   |  +-----------+    +-----------+     |     |  +---------+    +---------+           |   |
|   |  | Push to   |--->|    CI     |     |     |  |Checkout |--->|  Setup  |           |   |
|   |  |  GitHub   |    | Pipeline  |     |     |  |  Code   |    | Python  |           |   |
|   |  +-----------+    +-----------+     |     |  +---------+    +---------+           |   |
|   |         |              |            |     |       |              |                |   |
|   |         |              v            |     |       |              v                |   |
|   |         |    +-----------+          |     |  +---------+    +---------+           |   |
...
|             |   |  |  Logged  |  |Recorded |  |  Saved  ||                                 |
|             |   |  +---------+  +---------+  +---------+|                                 |
|             |   |  +-----------------------------------+|                                 |
|             |   |  |        Model Registry             ||                                 |
|             |   |  |  EnergyPredictor1 -> Production   ||                                 |
|             |   |  +-----------------------------------+|                                 |
|             |   +---------------------------------------+                                 |
|             |                                                                             |
|             |   +---------------------------------------+                                 |
...
|                                                                                            |
|   +-------------------------------------+     +---------------------------------------+   |
|   |           CO2 REDUCTION              |     |           MODEL ACCURACY              |   |
|   |                                     |     |                                       |   |
|   |            +-------------+          |     |            +-------------+            |   |
|   |            | 50-100 tons |          |     |            | MAE: 24.96  |            |   |
|   |            +-------------+          |     |            +-------------+            |   |
|   +-------------------------------------+     +---------------------------------------+   |
|                                                                                            |
|   +-------------------------------------+     +---------------------------------------+   |
